...
test(createValueNumber) {
    ...
    assertEqual(0.0, myNumberValue->getReportNumberData());
    assertEqual(0.0, myNumberValue->getControlNumberData());
    assertEqual("2022-02-14T10:18:16Z", myNumberValue->getReportTimestamp());
    assertEqual("2022-02-14T10:18:16Z", myNumberValue->getControlTimestamp());
